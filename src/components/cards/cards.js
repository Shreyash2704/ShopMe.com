...
export default function Cards(props) {
    ...
    function refreshPage() {
      ...
      const adminData = async() =>{
          ...
          const owner_data = await axios.get(`http://localhost:8000/auth/admin/${owner_id}`)
    ...
    const deleteData = async() =>{
         ...
         try{
             const deleteProduct = await axios.delete(`http://localhost:8000/product/delete/${p_id}`)
